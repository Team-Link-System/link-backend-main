...
type Post struct {
	...
	Departments []*Department `gorm:"many2many:post_departments;constraint:OnDelete:CASCADE;OnUpdate:CASCADE"` // N:N 관계 설정
	Teams       []*Team       `gorm:"many2many:post_teams;constraint:OnDelete:CASCADE;OnUpdate:CASCADE"`       // N:N 관계 설정
